				...
				<div class="jumbotron" style="padding-top: 20px;">
					<form method="post" action="joinAction.jsp">
						...
						<div class="form-group spacer" style="text-align: center;">
							<input type="radio" class="btn-check" name="userPosition" id="GK" autocomplete="off">
							<label class="btn btn-secondary" for="GK">GK</label>

							<input type="radio" class="btn-check" name="userPosition" id="DF" autocomplete="off">
							<label class="btn btn-secondary" for="DF">DF</label>

							<input type="radio" class="btn-check" name="userPosition" id="MF" autocomplete="off">
							<label class="btn btn-secondary" for="MF">MF</label>

							<input type="radio" class="btn-check" name="userPosition" id="FW" autocomplete="off">
